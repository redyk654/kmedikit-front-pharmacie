...
export default function FactureManuelle(props) {
    ...
    const annulerCommande = () => {
        refBtnAnnuler.current.disabled = false;
        refBtnValider.current.disabled = false;
        setMedocCommandes([]);
        setQtePrixTotal({});
        setmontantVerse('')
        setrelicat(0);
        ...
        if(medocCommandes.length === 0) {
          ...
          setMessageErreur("La date de la vente est manquante");
            ...
            medocCommandes.map(item => {
                ...
                data2.append('date_vente', dateVente);
                ...
                data2.append('status_vente', 'payé');
                ...
                req2.addEventListener('load', () => {
                    if (req2.status >= 200 && req2.status < 400) {
                        mettreAjourStock(item, dateVente);
                        setMessageErreur('');
